              ...
              <div className="relative">
                <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center overflow-hidden">
                  {(tenant as any).profile_photo_url ? (
                    <img 
                      src={(tenant as any).profile_photo_url} 
                      alt={tenant.name}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <p className="text-gray-900">{(tenant as any).date_of_birth ? formatDate((tenant as any).date_of_birth) : tenant.dob ? formatDate(tenant.dob) : 'Not provided'}</p>
                      </div>
                    </div>
                    <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Occupation</label>
                                                 <p className="text-gray-900">{(tenant as any).occupation}</p>
                      </div>
                                             {(tenant as any).employer_name && (
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Employer</label>
                                                     <p className="text-gray-900">{(tenant as any).employer_name}</p>
                        </div>
                      )}
                                             {(tenant as any).monthly_income && (
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Monthly Income</label>
                                                     <p className="text-gray-900">{formatCurrency((tenant as any).monthly_income)}</p>
                        </div>
                      )}
                    </div>
                  </CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Name</label>
                                                 <p className="text-gray-900">{(tenant as any).emergency_contact_name}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Phone</label>
                                                 <p className="text-gray-900">{(tenant as any).emergency_contact_phone || 'Not provided'}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Relationship</label>
                                                 <p className="text-gray-900">{(tenant as any).emergency_contact_relationship || 'Not specified'}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm">Overall Status</span>
                                             {getVerificationBadge((tenant as any).verification_status || 'pending')}
                    </div>
                                         {(tenant as any).verification_notes && (
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Notes</label>
                                                 <p className="text-sm text-gray-600">{(tenant as any).verification_notes}</p>
                      </div>
                    )}
                  </div>
                </CardContent>
